...
// Order order1 = new Order(1, "2024-05-19", "Shipped", 124, "789 Street", "101
...
// assertEquals("Shipped", insertedOrder.getStatus()); // Corrected the expected
// status
// }
...
// assertEquals("Shipped", fetchedOrder.getStatus()); // Corrected the expected
// status
// }
